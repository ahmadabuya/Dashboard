...
import AddCardModal from '../../component/AddCardModal/AddCardModal'
const BoardPage = () => {
  ...
  return (
    <div className="b-container">
        ...
        renderCard = {(props) =>(
            <div className='kanban-card' style={getGardient(props)}>
                <div>
                    <span>
                        {props.title}
                    </span>
                    <button className='remove-button' type='buton'
                    onClick={() => {
